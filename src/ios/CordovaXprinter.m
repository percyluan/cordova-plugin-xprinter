...
- (HLPrinter *)getPrinter
{
    ...
    // 图片 UIImage *image = [UIImageimageNamed:@"image.jpg"];
    
    
    [printer appendImage:[UIImage imageNamed:@"henganlogo"] alignment:HLTextAlignmentCenter maxWidth:300];
    UIImage *image = [UIImage imageNamed:@"henganlogo"];
